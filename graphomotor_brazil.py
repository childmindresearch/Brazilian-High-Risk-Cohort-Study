...
# Experiment screens
experiment_start = ["Bem-vindo(a) ao Protocolo Grafomotor. ", "", "", "Clique em ‘Avançar” para continuar."]
resting_state_instrc = [
    "Vamos iniciar a tarefa de estado de repouso",
    "Durante a tarefa, vamos pedir que você mantenha os olhos abertos ou fechados",
    "Para começar, por favor, mantenha os olhos abertos e olhe fixamente para o sinal de +",
    "", "", "Clique em ‘Avançar’ quando estiver pronto(a) para começar."
]
cross = ["+"]
